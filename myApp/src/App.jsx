...
export default function App(){
  ...
  const lists = async (user) => {
    const link = "https://listbases1-43jzz2k43q-uc.a.run.app?user=" + user
    const webby = (await axios.get(link))["data"]

    const names = webby["names"]
    const access  = webby["access"]

    for(let i = 0; i != names.length; i++){
      let x = document.createElement("div")
      x.classList.add("databases")

      const text1 = document.createElement("h1")
      text1.innerHTML = "<h1>Database name: </h1>"
      text1.classList.add("listText")

      const text2 = document.createElement("h1")
      text2.innerHTML = "<h1 >" + names[i] + "</h1>"
      text2.classList.add("listText")


      x.appendChild(text1)
      x.appendChild(text2)

      document.getElementById("lists").appendChild(x)
    }
    ...
    <div className="relative w-[100%] h-[100vh] m-auto p-[0] flex flex-row align-middle justify-center text-center bg-gray-300 overflow-hidden ">
      ...
      <div className="w-[85%] h-[100%] m-auto p-[0] relative flex flex-col align-middle justify-center text-center ">
        <section style={{transform: "translateY(" + 100 + "%)"}} id="database" className="flex overflow-x-hidden flex-col align-middle justify-center text-center min-w-[100%] min-h-[100vh] bg-violet-800  " >
          <div className="relative w-[100%] h-[10vh] bg-violet-900 m-auto p-[0] flex flex-col align-middle justify-center text-center  ">
          ...
          <div className="relative w-[100%] overflow-y-hidden overflow-x-hidden lg:overflow-y-hidden min-h-[90vh] m-auto p-[0] flex flex-col align-top gap-[10px] justify-start text-start bg-gray-700  ">
            ...
            <div className="relative w-[97%] lg:h-[20%] h-[50vh] m-auto p-[0] bg-transparent flex flex-col lg:flex-row align-middle justify-center text-center gap-[10px]  ">
              ...
              <div className="relative lg:w-[50%] w-[100%] lg:h-[85%] h-[50%] m-auto p-[0] flex flex-col align-middle justify-center text-center bg-gray-800 rounded-md ">
                ...
                <motion.button onClick={create? () => setCreate(false) : () => setCreate(true)} id="creation" initial={{scale: 1}} whileHover={{scale: 1.1}} whileTap={{scale: 0.9}} className="relative w-[10em] h-[2em] rounded-md cursor-pointer m-auto p-[0] text-xl text-white bg-gradient-to-tr from-blue-700 via-blue-800 to-blue-900  ">
                  + Create Database
                </motion.button>
              </div>
            </div>
            <div className="relative w-[97%] h-[100vh] lg:h-[60%] m-auto p-[0] bg-transparent flex flex-col lg:flex-row align-middle justify-center text-center gap-[10px]  ">
              <div className="relative w-[100%] lg:w-[50%] h-[50%] lg:h-[90%] m-auto p-[0] flex flex-col align-middle justify-center text-center bg-gray-800 rounded-xl ">
                <div className="relative w-[100%] h-[20%] m-auto p-[0] flex flex-col align-middle justify-center text-center  ">
                  <h1 className="text-2xl text-white">Current Database</h1>
                </div>
                <div className="relative w-[100%] h-[80%] m-auto p-[0] flex flex-col align-middle justify-center text-center  ">

                </div>
              </div>
              <div className="relative w-[100%] lg:w-[50%] h-[50%] lg:h-[90%] overflow-y-scroll lg:overflow-y-scroll m-auto p-[0] flex flex-col align-middle justify-center text-center bg-gray-800 rounded-xl ">
                <div className="relative w-[100%] h-[20%] m-auto p-[0] flex flex-col align-middle justify-center text-center  ">
                  <h1 className="text-2xl text-white">Database list - Click Your Databases</h1>
                </div>
                <div className="relative w-[100%] h-[80%] m-auto p-[0] flex flex-col align-middle justify-center text-center  ">
                  <div style={{display: create? "none": "flex"}} id="lists" className="relative w-[100%] h-[100%] m-auto p-[0] flex flex-col align-middle justify-center text-center ">
